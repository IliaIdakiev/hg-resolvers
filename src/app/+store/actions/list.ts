...
export const loadUserPost = createAction(
  '[USER LIST] Load User Post',
  (id: number) => ({ payload: { id } })
);
export const loadUserPostCancel = createAction(
  '[USER LIST] Load User Post Cancel'
);
export const loadUserPostSuccess = createAction(
  '[USER LIST] Load User Post Success',
  (post: any) => ({ payload: { post } })
);
export const loadUserPostFailure = createAction(
  '[USER LIST] Load User Post Failure',
  (error: Error) => ({ payload: { error } })
);
